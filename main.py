# Telegram Quiz Bot — stable, admin-only, Python 3.13 friendly
...
TICK_SECONDS  = 1.0         # countdown edit interval
POINTS_MAX    = 100
...
def compute_totals(st: GameState):
